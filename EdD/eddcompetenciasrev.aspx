<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="eddcompetenciasrev.aspx.cs" Inherits="EdD.eddcompetenciasrev" %>
...
<head runat="server">
    ...
    <script src="../js/competenciarev.js"></script>
</head>
<body>
...
<div style="margin-top: 20px; width:1400px;">
     <div style="float: left; width: 50px; margin-left: 568px;"><button id="instrcomp" onclick="instrcomp()" class="btn" >Instrucciones</button></div>
     ...
     <div style="float: left; width: 50px; margin-left: 48px;"><button id="aceptarjefecomp" onclick="actualiza_jefecomp(1)" class="btn" style="width: 63px; ">Aceptar</button></div>
     <div style="float: left; width: 50px; margin-left: 22px;"><button id="rechazarjefecomp" onclick="actualiza_jefecomp(0)" class="btn" style="width: 63px; ">Rechazar</button></div>
