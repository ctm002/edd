<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="eddobj.aspx.cs" Inherits="EdD.eddobj" %>
...
<div style="margin-top: 20px; width:1400px;">
     ...
     <div style="float: left; width: 50px; margin-left: 174px;"><button id="instrobj" onclick="instrobj()" class="btn" >Instrucciones</button></div>
    ...
    <div style="float: left; width: 50px; margin-left: 22px;"><button id="enviarajefatura" onclick="enviar_jefatura()" class="btn" style="width: 100px; ">A Jefatura</button></div>
     <div style="float: left; width: 50px; margin-left: 56px;"><button id="volver" onclick="volver()" class="btn" style="width: 63px; ">Inicio</button></div>        
</div>
<div style="clear:both"></div>
...
<div><button id="agregapaso" onclick="agregapaso()" style="font-weight: bold;" >+</button></div>
<div style="clear:both"></div>
</div>
...
<div style="clear:both"></div>
<div id="cajat42at1b"><select id="categoria4" name="categoria4" style="width: 120px">
  <option value="Cancelado">Cancelado</option>
  <option value="No iniciado">No iniciado</option>
  <option value="Retrasado">Retrasado</option>
  <option value="Segun planificacion">Segun planificacion</option>
...
<div style="clear:both"></div>
<div id="cajat52at1b"><select id="categoria5" name="categoria5" style="width: 120px">
  <option value="Cancelado">Cancelado</option>
  <option value="No iniciado">No iniciado</option>
  <option value="Retrasado">Retrasado</option>
  <option value="Segun planificacion">Segun planificacion</option>
...
<div id="cajat522"><textarea id="pasos51" name="pasos51" cols="63" rows="14" ></textarea></div>
</div>
<div style="clear:both"></div>
<div id="cajat52b">
...
<div id="cajat532"><textarea id="pasos52" name="pasos52" cols="63" rows="17" ></textarea></div>
</div>
</div>
</div>
...
<div id="instrucciones" style="font-size:14px;padding:6px;line-height: 130%;margin-top:6px;margin-left:90px;width:820px; height:450px; border: 1px solid #063E74; border-collapse: collapse; border-radius: 4px 4px 4px 4px; visibility:hidden;">
...
<div id="dialogoobjajefatura" title="Envia a Jefatura"></div>
<script>
